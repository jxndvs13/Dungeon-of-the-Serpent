...
arm = Armor("Leather Armor      C",4, 1, 5, 1,"\n\n\n")
arm = Armor("Studded Armor      C",4, 1, 5, 1,"\n\n\n")
arm = Armor("Chain Shirt        R",4, 2, 5, 1,"\n\n\n")
arm = Armor("Breastplate        R",4, 2, 5, 1,"\n\n\n")
arm = Armor("Chain Mail         L",4, 3, 5, 1,"\n\n\n")
arm = Armor("Plate Armor        L",4, 3, 5, 1,"\n\n\n")
...
wep = Weapon("Longbow            L",7, 3, 3, "Ranged","\n\n\n")
